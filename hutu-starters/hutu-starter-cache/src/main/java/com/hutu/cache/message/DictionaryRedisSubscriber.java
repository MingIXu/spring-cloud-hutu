...
public class DictionaryRedisSubscriber {
    ...
    public DictionaryRedisSubscriber(ReactiveStringRedisTemplate reactiveStringRedisTemplate, ChannelTopic channelTopic, SpringConfigProvider springConfigProvider) {
    ...
    /**
     * 刷新逻辑参考 {@link RefreshCache.RefreshTask#refreshUpperCaches(Object)}
     * @param cache
     * @param key
     */
