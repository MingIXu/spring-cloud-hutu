 ...
 *
 * @author hutu
 * @date 2020/7/1 2:42 下午
 */
@Slf4j
public class HutuSentinelInvocationHandler implements InvocationHandler {
	...
	HutuSentinelInvocationHandler(Target<?> target, Map<Method, InvocationHandlerFactory.MethodHandler> dispatch,
	...
	public boolean equals(Object obj) {
		if (obj instanceof com.alibaba.cloud.sentinel.feign.SentinelInvocationHandler) {
			HutuSentinelInvocationHandler other = (HutuSentinelInvocationHandler) obj;
