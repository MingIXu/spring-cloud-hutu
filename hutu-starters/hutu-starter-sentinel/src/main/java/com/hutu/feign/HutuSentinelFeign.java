 ...
 *
 * @author hutu
 * @date 2020/7/1 2:39 下午
 */
public final class HutuSentinelFeign {

    private HutuSentinelFeign() {

    }

    public static HutuSentinelFeign.Builder builder() {
        return new HutuSentinelFeign.Builder();
    }
    ...
    public static final class Builder extends Feign.Builder implements ApplicationContextAware {
        ...
        @Override
        public HutuSentinelFeign.Builder contract(Contract contract) {
        ...
        public Feign build() {
            super.invocationHandlerFactory(new InvocationHandlerFactory() {
                ...
                public InvocationHandler create(Target target, Map<Method, MethodHandler> dispatch) {
                    ...
                    Object feignClientFactoryBean = HutuSentinelFeign.Builder.this.applicationContext
                    ...
                    if (void.class != fallback) {
                        ...
                        return new HutuSentinelInvocationHandler(target, dispatch,
                                new FallbackFactory.Default(fallbackInstance));
                    }
                    if (void.class != fallbackFactory) {
                        fallbackFactoryInstance = (FallbackFactory) getFromContext(beanName, "fallbackFactory",
                                fallbackFactory, FallbackFactory.class);
                        return new HutuSentinelInvocationHandler(target, dispatch, fallbackFactoryInstance);
                    }
                    // 默认降级方案
                    return new HutuSentinelInvocationHandler(target, dispatch);
                }
