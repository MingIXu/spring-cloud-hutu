...
public class SecureUtils {
	 ...
	 * des 单例对象
	 */
	final static DES desDefault = SecureUtil.des(DES_SECRET_KEY.getBytes(Charsets.UTF_8));
	 ...
	 * aes 单例对象
	 */
	final static AES aesDefault = SecureUtil.aes(AES_SECRET_KEY.getBytes(Charsets.UTF_8));
	 ...
	 */
	/*
	 * public static void main(String[] args) { RSA rsa = SecureUtil.rsa(); String
	 * publicKeyBase64 = rsa.getPublicKeyBase64(); String privateKeyBase64 =
	 * rsa.getPrivateKeyBase64();
	 *
	 * String encrypt = desEncode("46464"); String decrypt = desDecode(encrypt); String
	 * encrypt1 = rsaEncode("7987987"); String decrypt1 = rsaDecode(encrypt1);
	 * System.out.println(decrypt); System.out.println(decrypt1);
	 *
	 * String secure = aesEncode("[9,\"aa\",{\"bb\":\"cc\"}]");
	 * System.out.println("secure: " + secure); String word = aesDecode(secure);
