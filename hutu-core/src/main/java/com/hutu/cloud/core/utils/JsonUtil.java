...
import com.hutu.cloud.core.function.CheckedConsumer;
...
public class JsonUtil {
	...
	@Nullable
	public static <T> T parse(@Nullable byte[] content, Class<T> valueType) {
    ...
    @Nullable
    public static <T> T parse(@Nullable String jsonString, Class<T> valueType) {
        return readValue(jsonString, valueType);
    }
	...
	@Nullable
	public static <T> T parse(@Nullable Reader reader, Class<T> valueType) {
