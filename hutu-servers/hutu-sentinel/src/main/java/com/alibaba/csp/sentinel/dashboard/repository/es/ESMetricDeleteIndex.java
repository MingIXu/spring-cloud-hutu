...
@Document(indexName = "sentinel" + "#{@eiu.getBefore10DayIndexNameSuffix()}")
public class ESMetricDeleteIndex implements Serializable {

	private static final long serialVersionUID = -1158059382115388479L;
