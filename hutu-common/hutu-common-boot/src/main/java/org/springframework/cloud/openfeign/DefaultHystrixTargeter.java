...
class DefaultHystrixTargeter implements Targeter {
	...
	public <T> T target(FeignClientFactoryBean factory, Feign.Builder feign, FeignContext context,
		...
		DefaultFallbackFactory DefaultFallbackFactory = new DefaultFallbackFactory(target);
		return (T) builder.target(target, DefaultFallbackFactory);
	}
